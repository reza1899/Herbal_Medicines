        ...
        <>
            <div className="main-register-form">
                <div className="form">
                    ...
                    <input className="" placeholder="تکرار رمز عبور " type="password" name="confirmPassword"
                    ...
                    <div className="provider">
                        <button className="d-flex justify-content-around" onClick={handleGoogleRegister}>Google <i
                            className="fab fa-google mt-1"></i></button>
                    </div>
